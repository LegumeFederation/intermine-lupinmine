...
//    private static final Logger LOG = Logger.getLogger(IntergenicRegionUtil.class);
    ...
    public IntergenicRegionUtil(ObjectStoreWriter osw) {
        ...
        dataSource.setName("Legume Federation");
        try {
            dataSource = os.getObjectByExample(dataSource, Collections.singleton("name"));
        } catch (ObjectStoreException e) {
            throw new RuntimeException("unable to fetch Legume Federation DataSource object", e);
        }
    }
    ...
    public void createIntergenicRegionFeatures()
        ...
        dataSet.setName("Derived intergenic regions");
        dataSet.setDescription("Intergenic regions created by InterMine post-processing.");
